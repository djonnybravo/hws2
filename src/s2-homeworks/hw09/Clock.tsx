...
function Clock() {
    ...
    const stringDate =  date.toLocaleDateString("en", { month: 'long', day: 'numeric'}) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем

    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    const stringDay = date.toLocaleString("en", {day: '2-digit',  }) || <br/> // пишут студенты
    const stringMonth = date.toLocaleString("en", {month: '2-digit' }) || <br/> // пишут студенты
